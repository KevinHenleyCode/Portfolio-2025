export default function Home() {
  return (
    <div className='text-gray-300 lg:px-20'>
      <section>
      ...
      <article className='text-md mt-10 tracking-widest sm:mt-16 sm:text-lg md:mt-20 md:text-xl [&>p]:mt-4'>
        ...
        <p>
          ...
          where I led a team of eight developers and helped modernize our stack
          from CakePHP to a Next.js/Express.js architecture, more than doubling
